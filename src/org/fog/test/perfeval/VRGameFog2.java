...
*/				moduleMapping.addModuleToDevice("connector", "cloud"); // fixing all instances of the Connector module to the Cloud
	...
	private static void createFogDevices(int userId, String appId) {
		FogDevice cloud = createFogDevice("cloud", 45000, 40000, 100, 10000, 0, 0.01, 16*103, 16*83.25); // creates the fog device Cloud at the apex of the hierarchy with level=0
		cloud.setParentId(-1);
	...
	private static FogDevice addGw(String id, int userId, String appId, int parentId){
		FogDevice dept = createFogDevice("d-"+id, 3000, 4000, 10000, 10000, 1, 0.0, 107.339, 83.4333);
		fogDevices.add(dept);
	...
	private static Application createApplication(String appId, int userId){
		...
		if(EEG_TRANSMISSION_TIME==10)
			...
			application.addAppEdge("EEG", "client", 3000, 10, "EEG", Tuple.UP, AppEdge.SENSOR);
